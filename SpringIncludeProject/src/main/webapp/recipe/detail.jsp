...
<body>
  <table class="table">
   ...
   <tr>
    <td class="text-center"><img src="../recipe/a1.png"></td>
    <td class="text-center"><img src="../recipe/a2.png"></td>
    <td class="text-center"><img src="../recipe/a3.png"></td>
   </tr>
   <tr>
  ...
  <table class="table">
   ...
   <tr>
     <td width="20%" rowspan="2">
       <img src="${vo.chef_poster }" style="width:100px; height: 100px;" class=>
     </td>
